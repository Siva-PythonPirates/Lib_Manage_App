...
abstract class BookDetails implements Built<BookDetails, BookDetailsBuilder> {
  BookDetails._();
  factory BookDetails([void Function(BookDetailsBuilder) updates]) = _$BookDetails;

  Map<String, dynamic> toJson() {
    return serializers.serializeWith(BookDetails.serializer, this) as Map<String, dynamic>;
  }
